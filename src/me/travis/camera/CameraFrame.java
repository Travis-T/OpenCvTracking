...
public class CameraFrame extends JFrame {
    ...
    public CameraFrame(JLabel label, Camera camera) {
       ...
       /**SLIDERS USED TO FIND THE RANGE OF RBG COLORS OF OBJ.
    ...
    /**
     * Repaints the JLabel's image so the next frame
     * @param imageIcon     The new frame
     * @return  true - The image was successfully repainted | false - The image was null
     */
